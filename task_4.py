...
value_x = float(input("Введите действительное положительное число: "))
value_y = int(input("Введите целое отрицательное число: "))
print(f"Возведение числа {value_x} в степень {value_y}")
...
print(f"Результат функции c *        : {my_func_1(value_x, value_y)}")
print(f"Результат функции без *      : {my_func_2(value_x, value_y)}")
print(f"Результат проверочной функции: {my_func_test(value_x, value_y)}")
